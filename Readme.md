...
Для того чтобы перейти с одной ветки на другую нужно использовать команду *git checkout <название ветки>*. Для удобства можно сначала узнать список веток через команду git branch и дальше необходимо без ошибок написать команду *git checkout <название ветки>*. 
